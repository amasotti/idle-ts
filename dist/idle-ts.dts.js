const bulkAddEventListener = (window, events, callback) => {
 ...
 * @param callback
 */
const bulkRemoveEventListener = (window, events, callback) => {
    events.forEach((event) => {
...
class IdleTs {
    ...
    throwOnBadKey = (keys, allowedKeys) => {
